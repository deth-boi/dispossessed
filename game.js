...
const scenes = {
    "start": {
        image: "images/room-start.jpg",
        dialogue: "You step into the abandoned UAC facility. The air smells like blood and ozone.",
        hotspots: [
            // Example: change these numbers to your real door coordinates
            { x: 620, y: 340, w: 280, h: 520, target: "hallway", name: "Security Door" }
        ]
    },
    "hallway": {
        image: "images/room-hallway.jpg",
        dialogue: "A long corridor stretches before you. Something drips in the distance...",
        hotspots: [
